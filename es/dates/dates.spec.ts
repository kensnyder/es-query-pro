const {
  ...
  dateToNumber,
  // @ts-expect-error TS(2451): Cannot redeclare block-scoped variable 'processRec... Remove this comment to see the full error message
  processRecord,
  ...
  unixToDate,
  // @ts-expect-error TS(2451): Cannot redeclare block-scoped variable 'unProcessR... Remove this comment to see the full error message
  unProcessRecord,
